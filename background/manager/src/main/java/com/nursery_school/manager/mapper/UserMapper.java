...
public interface UserMapper {
     ...
     *
     * @mbg.generated Sat Sep 28 14:46:29 CST 2019
     */
    @Delete({
        "delete from t_user",
    ...
    @Delete({
        "delete from t_user",
        "where parents_id = #{id,jdbcType=VARCHAR}"
    })
    ...
    @SelectProvider(type = com.nursery_school.manager.model.dyna.UserDynaProvider.class, method = "selectProvider")
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.VARCHAR, id=true),
        @Result(column="name", property="name", jdbcType=JdbcType.VARCHAR),
        @Result(column="login_name", property="loginName", jdbcType=JdbcType.VARCHAR),
    ...
    @UpdateProvider(type = com.nursery_school.manager.model.dyna.UserDynaProvider.class, method = "updateProvider")
	int updateDymic(Map<String, Object> map);
